...
var ary2utf8 = (function() {
  ...
  patterns.forEach(function(item) {
    ...
    for (i = 0, len = item.data_length; i < len; i++) {
      mask += '0';
    }
    item.mask = mask;
...
var utf82ary = (function() {
  ...
  var code2utf8array = function(code) {
    ...
    var ary = [];
    for (i = 0, len = pattern.bytes - 1; i < len; i++) {
...
Object.assign(HttpServer.prototype, EventSource.prototype);
...
Object.assign(HttpRequest.prototype, EventSource.prototype);
...
Object.assign(WebSocketServer.prototype, EventSource.prototype);
...
Object.assign(WebSocketRequest.prototype, HttpRequest.prototype);
    ...
    var onDataRead = function(dataBuffer) {
      ...
      while (data.length) {
        ...
        if (length_code > -1 && data.length >= data_start + length_code) {
          var tmpArr = data.slice(data_start, data_start + length_code);
          var decoded = [];
...
Object.assign(WebSocketServerSocket.prototype, EventSource.prototype);
